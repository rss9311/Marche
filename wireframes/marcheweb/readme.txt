...
- FAQ
- Login / register
- User Actions - orders history
- User Actions - order detail
- User Actions - wishlist
- User Actions - change password / personal details
- Blog - listing
- Blog - post
- 404
- Contact page
...
Google maps are used on the contact page. If you need just to show location of the company on the map, the only neccessary thing is to change coordinates in the header of contact.jsp. For further settings and possibilities please consult [Google Maps API documentation](https://developers.google.com/maps/documentation/javascript/).
