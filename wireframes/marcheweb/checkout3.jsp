                    ...
                    <div class="box">
                        <form method="post" action="checkout4.jsp">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                ...
                                <li class="disabled"><a href="checkout4.jsp"><i class="fa fa-eye"></i><br>Order Review</a>
                                </li>
                            </ul>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="basket.jsp" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Shipping method</a>
                                </div>
