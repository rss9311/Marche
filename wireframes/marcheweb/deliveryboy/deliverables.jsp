                            ...
                            <table class="table table-hover dataTable" id="dataTables">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>22/06/2013</td>
                                        <td>$ 150.00</td>
                                        <td><span class="label label-info">Order-Confirmed</span>
                                        </td>
                                        <td><a href="deliver-order.jsp" class="btn btn-primary btn-sm">View</a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>22/06/2013</td>
                                        <td>$ 150.00</td>
                                        <td><span class="label label-warning">Pickedup</span>
                                        </td>
                                        <td><a href="deliver-order.jsp" class="btn btn-primary btn-sm">View</a>
                                        </td>
                                    </tr>
