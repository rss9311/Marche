        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <h2 class="seller"><span class="col-md-8">Mahendra
                            &nbsp;&nbsp;
                        <span class="fa fa-star true"></span>
								<span class="fa fa-star true"></span>
								<span class="fa fa-star true"></span>
								<span class="fa fa-star"></span>
								<span class="fa fa-star"></span> (<span style="color:green">9</span>) 
                        </span>
                        <span class="col-md-2">
                        </span>
                        <span class="col-md-2">                         
                        <a href="#" class="btn btn-primary btn-sm follow" > <i class="fa fa-bell" aria-hidden="true"></i> Follow</a>
                        </span></h2>
