            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            <li><a href="aboutus.jpg">About us</a>
                            </li>
                            <li><a href="termsandc.jpg">Terms and conditions</a>
                            </li>
                            <li><a href="FAQ.jpg">FAQ</a>
                            </li>
                            <li><a href="contact.jpg">Contact us</a>
                            </li>
                        </ul>
...
/* var $divs1 = $("div.prod");
    	...
    	$('#filter').on('change', function(event) {
    		...
    		if(this.value==1){
    			System.out.println("here");
    			 var PriceDivs1 = $divs1.filter(function (a, b) {
    	    	        return "0" <$(a).find(".price").text().replace('$','');
    	    	    });
 	    	    
    	    	    $(".products").html(PriceDivs1);
    		}
    		if(this.value==2){
    			 var PriceDivs1 = $divs1.sort1(function (a, b) {
 	    	        return "$10" <$(a).find(".price").text() <"$1000";
 	    	    });
 	    	    $(".products").html(PriceDivs2);
    		}
    		
    		if(this.value==3){
    			 var PriceDivs3 = $divs1.sort1(function (a, b) {
 	    	        return "$1000" <$(a).find(".price").text() < "$2000";
 	    	    });
 	    	    $(".products").html(PriceDivs3);
