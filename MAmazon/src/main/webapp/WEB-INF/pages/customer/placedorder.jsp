    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
        ...
        <li><a href="orders-placed">My orders</a>
        </li>
        ...
        <c:forEach items="${orderInfo.details}" var="orderDetailInfo">
            ...
            <td> <fmt:formatNumber value="${orderDetailInfo.price}" type="currency" currencySymbol="&#x20B9;"/> </td>
            <td> <fmt:formatNumber value="${orderDetailInfo.amount}" type="currency" currencySymbol="&#x20B9;" /> </td>
