                                ...
                                <c:forEach items="${productInfos}" var="info">
                                    ...
                                    <a href="${pageContext.request.contextPath}/detail?id=${info.id}">
                                      ...
                                      <%--   <td>${info.addedTime}</td> --%>
                                        <td><fmt:formatNumber value="${info.price}" type="currency" currencySymbol="&#x20B9;"/></td>
                                        ...
                                        <td>
                                        <a href="${pageContext.request.contextPath}/customer/editProduct?id=${info.id}" class="btn btn-primary btn-sm edit">Edit</a>
                                        <%-- <a href="${pageContext.request.contextPath}/detail?id=${info.id}" class="btn btn-primary btn-sm">View</a> --%>
                                        <a href="${pageContext.request.contextPath}/customer/deleteProduct?id=${info.id}"  class="btn btn-primary btn-sm" >Delete</a> 
                                        </td>
                                    </tr>
                                    </c:forEach>
