...
<!--                 <a href="#" class="btn btn-success btn-sm" data-animate-hover="shake">Offer of the day</a>  <a href="#">Get flat 35% off on orders over $50!</a>
 -->            </div>
            ...
            <c:when test="${empty pageContext.request.userPrincipal.name}">
             ...
             <ul class="menu">
                    <li><a href="${pageContext.request.contextPath}/deliveryboy/account"><b>Welcome ${pageContext.request.userPrincipal.name}</b></a>
                    </li>                    
             ...
             <ul class="menu">
                   <%--  <li><a href="${pageContext.request.contextPath}/customer/account"> </a><b>Welcome ${pageContext.request.userPrincipal.name}</b>
                    </li>   --%> 
...
<div class="autocompletesearch">
            ...
            <div class="navbar-buttons">
               ...
               <%--  <div class="navbar-collapse collapse right" id="basket-overview" >
                    <a href="wishlist" class="btn btn-primary navbar-btn" class="btn btn-primary navbar-btn"><i class=" fa fa-heart"></i><span class="hidden-sm"><b> (${optionCount.get("wishlistcount")}) </b></span></a>
                </div>
                <div class="navbar-collapse collapse right" id="basket-overview" >
                    <a href="customer/orders-received" class="btn btn-primary navbar-btn"><i class="fa fa-bell"></i><span class="hidden-sm"><b>  (${optionCount.get("receivedorders")}) </b></span></a>
                </div> --%>
