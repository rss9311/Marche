...
img#OffAmazonPaymentsWidgets0 {
            ...
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
					<div>${exceptionMsg}</div>
					  ...
					  <input type="hidden" id="mws_access_key" value="AKIAJIEHSXQUWSCPCQVA">
				      <input type="hidden" id="mws_secret_key" value="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">
				      <input type="hidden" id="merchant_id" value="A24EGAD7BNPFHV">
				      <input type="hidden" id="client_id" value="amzn1.application-oa2-client.50aff10344a043b4b199f2364dd56057">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                    	...
                                    	<c:forEach items="${cartForm.cartLines}" var="cartLineInfo"   varStatus="varStatus">
                                            ...
                                            <td><fmt:formatNumber value="${cartLineInfo.productInfo.price}" type="currency"  currencySymbol="&#x20B9;"/></td>
                                           <!--  <td>$0.00</td> -->
                                            <td><fmt:formatNumber value="${cartLineInfo.amount}" type="currency"  currencySymbol="&#x20B9;"/></td>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="2"><fmt:formatNumber value="${myCart.amountTotal}" type="currency" currencySymbol="&#x20B9;" /></th>
                                        </tr>
                                    	</tfoot>
                                         </c:if>
                                    </table>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <th><fmt:formatNumber value="${myCart.amountTotal}" type="currency"  currencySymbol="&#x20B9;"/></th>
                                    </tr>
                                  <!--   <tr>
 ...
 <script type="text/javascript">
            window.onAmazonLoginReady = function() {
                amazon.Login.setClientId('amzn1.application-oa2-client.50aff10344a043b4b199f2364dd56057');
            };
            ...
            function showButton() {
                var authRequest;
                OffAmazonPayments.Button("AmazonPayButton", "A24EGAD7BNPFHV", {
                    type: "PwA",
                    color: "Gold",
                    size: "medium",
